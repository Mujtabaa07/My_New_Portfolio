      ...
      {activeItem && (
        <div className="group">
          ...
          <div
            ...
            `}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white bg-black/40 backdrop-blur-sm px-4 py-2 rounded-lg border border-gray-700/50">
              {activeItem.title}
            </h2>
          </div>
          ...
          <div
            className={`
              absolute top-6 right-6 z-20 max-w-xs
              transition-all duration-500 ease-out
              ${isMoving 
                ? 'opacity-0 translate-y-4 pointer-events-none' 
                : 'opacity-100 translate-y-0 pointer-events-auto'
            ...
            `}
          >
            <p className="text-sm md:text-base text-gray-200 bg-black/40 backdrop-blur-sm p-4 rounded-lg border border-gray-700/50 leading-relaxed">
              {activeItem.description}
            </p>
          </div>

          {/* Single Action Button - appears on hover over any text area */}
          <div
            onClick={handleButtonClick}
            className={`
              absolute top-6 left-1/2 transform -translate-x-1/2 z-30
              ...
              hover:scale-110
              ${isMoving || !activeItem.link
                ? 'opacity-0 scale-75 translate-y-2 pointer-events-none' 
                : 'opacity-0 scale-75 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:translate-y-0 group-hover:pointer-events-auto'
              }
            `}
          >
            <svg 
